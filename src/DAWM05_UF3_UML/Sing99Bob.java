...
/*
 * an instance of Drinkers, after being pointed at a wall containing beer, will
 * periodically take one down. The singing is driven by the taking of the beer.
 */
...
/*
 * an instance of a WallOfBeer will maintain a count of the beer bottles. The
 * wall has an associated Narrator who reports each time the number of bottles
 * is changed.
 */
...
/*
 * an instance of Narrator sings the verse each time it is notified that
 * something has happened to the wall. This narrator attempts to be grammatical,
 * and uses words for the bottle count (singers sing words not numerals). The
...
class Narrator implements WallWatcher {
	...
	static final String onwall = " on the wall", takedown = "Take one down and pass it around, ",
